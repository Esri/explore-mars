  ...
  return (
    <PointerEventsContainer children={(
      <nav class={styles.menu}>
        <a
          class={cx(styles.menuItem, styles.explore)}
          onclick={(e: Event) => { onItemClick('landing') }}
        >
          <img class={cx(styles.icon, styles.exploreLogo)} src="../images/logo.png" alt="Explore Mars" />
        </a>
        <div class={styles.items}>
          <a
            class={cx(styles.menuItem, styles.location)}
            onclick={(e: Event) => { onItemClick('locations') }}
          >
          ...
          <a
            ...
            onclick={(e: Event) => { onItemClick('measure') }}
          >
          ...
          <a
            ...
            onclick={(e: Event) => { onItemClick('compare') }}
          >
        ...
        <a
          class={cx(styles.menuItem, styles.credits)}
          onclick={(e: Event) => { onItemClick('credits') }}
        >
          <img class={cx(styles.icon, styles.esriLogo)} src="../images/esri-logo.png" title="Credits" alt="" />
